...
\sigla{IMS}{IMS}{Ingestão de Matéria Seca}
\sigla{CNCPS}{CNCPS}{\textit{Cornell Net Carbohydrate and Protein System}}
\sigla{NRC}{NRC}{\textit{National Research Council}}

\sigla{UI}{UI}{\textit{User Interface}}

\sigla{URL}{URL}{\textit{Uniform Resource Locator}}
...
\sigla{MSW}{MSW}{\textit{Mock Service Worker}}

\sigla{CRUD}{CRUD}{Criação, Consulta, Atualização e Exclusão, do inglês \textit{Create, Read, Update and Delete}}

\sigla{HTTP}{HTTP}{\textit{Hypertext Transfer Protocol}}

\sigla{SVG}{SVG}{\textit{Scalable Vector Graphics}}
...
\sigla{MS}{MS}{Matéria Seca}

\sigla{EE}{EE}{Extrato Etéreo}

\sigla{PDR}{PDR}{Proteína Degradável no Rúmen}

\sigla{CNF}{CNF}{Carboidratos Não Fibrosos}
