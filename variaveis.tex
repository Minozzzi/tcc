...
\titleen{WEB CLIENT FOR NUTRITIONAL BALANCING AND MANAGEMENT OF DAIRY CATTLE} % Título traduzido para inglês
...
\PalavraChaveA{bovinocultura}%% Palavra-chave A
\PalavraChaveB{produ\c{c}\~ao leiteira}%% Palavra-chave B
\PalavraChaveC{balancemaneto nutricional}%% Palavra-chave C
\PalavraChaveD{gest\~ao de rebanho}%% Palavra-chave D
\PalavraChaveE{sistema web}%% Palavra-chave E
...
\KeywordA{cattle farming}%% Keyword A
\KeywordB{dairy production}%% Keyword B
\KeywordC{nutritional balance}%% Keyword C
\KeywordD{herd management}%% Keyword D
\KeywordE{web system}%% Keyword E
