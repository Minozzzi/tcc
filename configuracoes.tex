...
%% Configurações para códigos (listings)
\usepackage{listings}
\usepackage{xcolor}
...
\definecolor{typecolor}{rgb}{0.16,0.5,0.5}

% JavaScript
\lstdefinelanguage{JavaScript}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, as, async, await, class, const, constructor, export, extends, import, let, static},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\lstdefinelanguage{TypeScript}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, as, async, await, class, const, constructor, export, extends, import, let, static, abstract, any, boolean, declare, enum, implements, interface, is, keyof, module, namespace, never, number, object, package, private, protected, public, readonly, require, string, symbol, type, undefined, unique, unknown, yield},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
\lstdefinelanguage{TSX}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, as, async, await, class, const, constructor, export, extends, import, let, static, abstract, any, boolean, declare, enum, implements, interface, is, keyof, module, namespace, never, number, object, package, private, protected, public, readonly, require, string, symbol, type, undefined, unique, unknown, yield, Fragment, key, ref, className, onClick, onChange, onSubmit},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
  morestring=[b]`,
  moredelim=[s][\color{typecolor}]{<}{>},
}
