...
\begin{itemize}
  ...
  \item Controlar os níveis de acesso aos dados de forma eficiente.

  \item Assegurar a manutenção e atualização dos dados coletados das propriedades de maneira eficaz.
\end{itemize}
