...
Este trabalho está estruturado em capítulos. O \autoref{cap:introducao}, abrange as considerações iniciais, o objetivo geral, os objetivos específicos e a justificativa do trabalho. O \autoref{cap:referencialTeorico} aborda o referencial teórico, que consiste na fundamentação teórica do trabalho, explorando temas e conceitos relacionados ao desenvolvimento deste estudo. O \autoref{cap:materialemetodos} detalha os materiais utilizados para o desenvolvimento do trabalho e descreve o método empregado. O \autoref{cap:resultados} apresenta os resultados funcionais e a modelagem do sistema. O \autoref{cap:implementacao} detalha as decisões arquiteturais e a codificação das camadas do sistema. O \autoref{cap:conclusao} sintetiza as considerações finais e as perspectivas de evolução do software. Por fim, as referências bibliográficas utilizadas são apresentadas.
