...
Aprimorar a coleta, armazenamento e administração de dados nessa atividade pode ser alcançado por meio da adoção de um sistema de informação. Isso permite que técnicos e proprietários efetuem um gerenciamento mais eficaz do rebanho, contribuindo para a tomada de decisões embasadas. Com o intuito de otimizar o uso do tempo e simplificar a carga de trabalho, esta pesquisa apresenta o desenvolvimento de um sistema web, destinado a facilitar a gestão dos animais, o acompanhamento nutricional e o monitoramento do gado leiteiro nas propriedades rurais. Essa ferramenta visa beneficiar tanto o trabalho dos técnicos do \gls{IDR-PR} quanto o trabalho dos próprios produtores.

O propósito do cliente web elaborado neste estudo é operar de forma integrada com um aplicativo móvel e uma \gls{API} com arquitetura de \gls{REST}, os quais fazem parte do mesmo projeto global. Apesar de esses sistemas adicionais estarem sendo desenvolvidos concomitantemente com o presente trabalho, eles estão fora do âmbito que está sendo abordado neste contexto. Contudo, é relevante mencionar a existência desses sistemas complementares, dado que o funcionamento do sistema web é dependente da interação com a \gls{API} \gls{REST} para acessar os dados necessários e compartilhá-los com o aplicativo móvel.

Está em progresso o desenvolvimento da \gls{API} \gls{REST}, a qual foi equipada com \textit{endpoints} que possibilitam ao cliente web acessar e manipular os dados essenciais para o seu funcionamento. Essa \gls{API} foi estruturada em conformidade com os princípios do estilo arquitetural \gls{REST}, promovendo, assim, uma comunicação eficaz e padronizada entre o aplicativo móvel e o cliente web. A concepção do aplicativo móvel, por sua vez, está focada na criação de uma interface simples e intuitiva, visando a facilitação de inserção e manuseio dos dados quando o técnico estiver fazendo a visita à propriedade, sendo que o aplicativo móvel funciona de maneira complementar ao cliente web.

\section{Objetivos}\label{sec:objetivos}

Nesta seção, apresentam-se o objetivo geral e os objetivos específicos do cliente proposto neste trabalho. O objetivo geral representa o resultado central que se buscou alcançar, enquanto os objetivos específicos delineiam as principais funcionalidades do cliente web em questão.
...
\begin{itemize}
  ...
  \item Simplificar o registro do fluxo de visitas à propriedade de forma modular, permitindo que o técnico responsável colete dados relacionados ao gado.
...
Ao deparar-se com tal situação, é possível afirmar que a solução para o problema pode estar na elaboração de um cliente web, para que seja possível ter o gerenciamento dos dados do gado leiteiro, realizar o manuseio e controle das visitas nas propriedades rurais, controle de insumos e produtos e controle de pragas e doenças nas plantações da propriedade. Dessa maneira, possibilitará que os dados fiquem centralizados otimizando a emissão de relatório, a manutenibilidade dos dados e extração de resultados provenientes da coleta de dados para auxiliar na tomada de decisão por parte dos técnicos.

\section{Estrutura do trabalho}\label{sec:estruturaTrabalho}

Este trabalho está estruturado em capítulos. O \autoref{cap:introducao}, abrange as considerações iniciais, o objetivo geral, os objetivos específicos e a justificativa do trabalho. O \autoref{cap:referencialTeorico} aborda o referencial teórico, que consiste na fundamentação teórica do trabalho, explorando temas e conceitos relacionados ao desenvolvimento deste estudo. O \autoref{cap:materialemetodos} detalha os materiais utilizados para o desenvolvimento do trabalho e descreve o método empregado. O \autoref{cap:resultados} apresenta os resultados funcionais e a modelagem do sistema. A \autoref{sec:implementacaoSistema} detalha as decisões arquiteturais e a codificação das camadas do sistema. O \autoref{cap:conclusao} sintetiza as considerações finais e as perspectivas de evolução do software. Por fim, as referências bibliográficas utilizadas são apresentadas.
