...
Nesta seção, são delineados os requisitos funcionais e não funcionais, os casos de uso e os diagramas que descrevem os processos e a estrutura do sistema a ser desenvolvido. Cada requisito funcional é introduzido, seguido dos requisitos não funcionais pertinentes.
...
\begin{tabframed}[htb]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{1}{|p{8cm}|}{\raggedright O sistema deve garantir respostas eficientes por meio de estratégias de \textit{caching} no lado do cliente (\textit{frontend}), utilizando tecnologias como TanStack Query para otimização de requisições.}
    \\ \cline{1-2}
...
\begin{tabframed}[htb]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{1}{|p{9cm}|}{\raggedright O sistema deve garantir respostas eficientes por meio de estratégias de \textit{caching} no lado do cliente (\textit{frontend}), utilizando tecnologias como TanStack Query para otimização de requisições.}
    \\ \cline{1-2}

    NF 4.4 Correlacionamento com Produtor &
    \multicolumn{1}{|p{9cm}|}{\raggedright O sistema deve disponibilizar formas de correlacionar o produtor dono da propriedade e os demais colaboradores.}
    \\ \cline{1-2}
...
\begin{tabframed}[!htb]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{1}{|p{3.2cm}|}{\raggedright NF 5.3 Desempenho Eficiente}
                  &
    \multicolumn{1}{|p{12cm}|}{\raggedright O sistema deve garantir respostas eficientes por meio de estratégias de \textit{caching} no lado do cliente (\textit{frontend}), utilizando tecnologias como TanStack Query para otimização de requisições.}
    \\ \cline{1-2}
...
\begin{tabframed}[!htb]
  ...
  \begin{tabular}{|l|l|}
    ...
    \multicolumn{1}{|p{3cm}|}{\raggedright NF 10.8 Dados de vacas e balanceamento}      &
