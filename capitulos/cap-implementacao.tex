...
A gestão do rebanho permite um controle cirúrgico do plantel por meio de uma interface dedicada, como pode ser visualizado na \autoref{fig:sys-animais}.
...
\caption{\label{lst:http-client}Contrato Genérico de HttpClient}
...
\begin{sourcecode}[htb]
\caption{\label{lst:msw-delay}Simulação de Delay Realista no \gls{MSW}}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:msw-auth}Middleware de Autenticação Fake no Mock}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:msw-handlers}Registro Modular de Handlers no \gls{MSW}}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:folder-structure}Estrutura de Pastas Padronizada (Módulo Animais)}
\begin{lstlisting}[]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-models}Modelos de Dados do Domínio}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-use-cases}Contratos de Casos de Uso (\gls{CRUD}) no Domínio}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-data}Implementações da Camada Data (\gls{CRUD})}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-main}Fábricas de Injeção de Dependências}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-mock}Handlers \gls{MSW} para Simulação de \gls{API}}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-context}Gerenciamento de Estado no Context \gls{API}}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-hook}Hook de Integração com TanStack Query}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-table}Componente AnimalDataTable Focado em Renderização}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-types}Tipos da Camada de Apresentação}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-validations}Esquema de Validação com Zod}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animal-form-inputs}Composição de Campos do Formulário}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:create-animal-form}Lógica de Criação no Formulário}
\begin{lstlisting}[language=TypeScript]
...
\begin{sourcecode}[htb]
\caption{\label{lst:animals-screen}Renderização Declarativa na Página de Animais}
\begin{lstlisting}[language=TypeScript]
